...
# Result directories
# mkdir -p ${HOME}/${PROJECT_DIR}/results/synthetic/55
mkdir -p ${HOME}/${PROJECT_DIR}/results/synthetic/76

# Running multiple configurations (different originals and fakes)
# srun ${HOME}/${PROJECT_DIR}/scripts/run_multiple_confs.sh ${HOME}/${PROJECT_DIR}/configurations/synthetic/train_55.json
srun ${HOME}/${PROJECT_DIR}/scripts/run_multiple_confs.sh ${HOME}/${PROJECT_DIR}/configurations/synthetic/train_76.json
